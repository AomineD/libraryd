...
import static com.dagf.dialoglibrary.dialog.PopUpShare.key_session;


public class PopUpShare2 extends AlertDialog {
    public PopUpShare2(Context context) {
        super(context);
    }
    ...
    protected PopUpShare2(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    protected PopUpShare2(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(Uri.parse(url_img)).transform(new CropCircleTransformation()).fit().placeholder(R.drawable.loading_ic).into(img);
